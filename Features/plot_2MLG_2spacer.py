...
for j in range(len(e22)):
    for i in range(len(d)):
        ...
        data_path = os.path.join(
            ...
            f'd={d[i]}-ni1=0.45e12-e21=4-e22={e22[j]}.txt'
        )
        ...
        plt.title(f'2MLG - 2spacer - ni1=0.45e12 - d = {d[i]}nm - e21=4 - e22 = {e22[j]}')

        # Plot with distinct styles
        plt.plot(x, y1, label='r0 = 0', color='blue')
        plt.plot(x, y2, label='r0 = 5a0', color='green')
        plt.plot(x, y3, label='r0 = 10a0', color='red')
        ...
        save_path = os.path.join(
            ...
            f'd={d[i]}ni1=0.45e12-e21=4-e22={e22[j]}.pdf'
        )
